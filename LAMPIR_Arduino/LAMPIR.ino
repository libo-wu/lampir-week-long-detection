...
#define volNum        240   // the number of the array 
#define gain          1
#define led           2
...
int OccuVolDiff = 150*gain;     //  threshold voltage for occupant presence
int vol[volNum];
int volRead_index=0;
int PeakNum=0;
int peak2peak=0;
...
//      BTserial.print("\n");
    if(peak2peak>=OccuVolDiff){
      OccuState=OccuState<<1;   //if larger than threshold, then write OccuInfo[8] to 1
